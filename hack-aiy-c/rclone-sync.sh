...
rcloneName="rpiUpload"     # Name of Remote Storage Service
syncRoot="/home/pi/Desktop"      # Root Folder to Start
localDir="vidio"      # Source Folder on Local
remoteDir="vidio"     # Destination Folder on Remote
